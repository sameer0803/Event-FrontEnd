...
// const styles = `
//   @import url('https://fonts.googleapis.com/css2?family=Rajdhani:wght@500;600&family=Inter:wght@300;400&display=swap');

//   .footer {
//     width: 100%;
//     background: radial-gradient(ellipse at 50% -20%, #1b4d4f 0%, #0f2027 60%);
//     color: #ffffff;
//     padding: 28px 6% 18px;
...
//     box-shadow: 0 0 12px rgba(53, 208, 186, 0.5);
//   }
...
//           <p className="footer-copy">© 2025 Grand Sameer Events Pvt. Ltd. All rights reserved.</p>
...
//     {/* LinkedIn */}
//     <SocialIcon href="https://linkedin.com/company" label="LinkedIn"
